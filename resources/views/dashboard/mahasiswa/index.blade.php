                        ...
                        @foreach ($users as $u)
                            <tr>
                                ...
                                <td class="flex gap-4 border-b border-gray-200 whitespace-no-wrap px-6 pt-4">
                                    {{-- Edit Button --}}
                                    <a href="/dashboard/mahasiswa/{{ $u->id }}" class="">
                                        <i class="fa fa-eye scale-110 text-green-600 hover:text-green-800 pt-1 mr-1"></i>
                                    </a>
                                    <a href="/dashboard/mahasiswa/{{ $u->id }}/edit" class="">
                                    ...
                                    {{-- Delete Button --}}
                                    <form action="/dashboard/mahasiswa/{{ $u->id }}"
                                        onsubmit="return confirm('Anda yakin untuk menghapus mahasiswa ini?')"
